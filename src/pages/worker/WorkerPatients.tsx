      ...
      {activeTab === 'create' ? (
        ...
        <div className="max-w-2xl mx-auto bg-white p-6 sm:p-8 rounded-3xl border border-[#DCEAE7] shadow-sm space-y-6">
          <div className="border-b border-[#DCEAE7] pb-3">
            <h2 className="text-lg font-bold text-[#0D2B3E]">Walk-In Patient Quick Registration</h2>
            <p className="text-xs text-slate-500">Fill in basic contact details to generate OPD queue token</p>
          </div>

          <form onSubmit={handleCreate} className="space-y-4 text-xs">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block font-bold text-[#0D2B3E] mb-1">Full Name *</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block font-bold text-[#0D2B3E] mb-1">Mobile Number *</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block font-bold text-[#0D2B3E] mb-1">Age & Gender</label>
              ...
              <div>
                <label className="block font-bold text-[#0D2B3E] mb-1">Blood Group</label>
                <select
              ...
              <div className="sm:col-span-2">
                <label className="block font-bold text-[#0D2B3E] mb-1">Residential Area / City</label>
                <input
                  type="text"
              ...
              <div className="sm:col-span-2">
                <label className="block font-bold text-[#0D2B3E] mb-1">Main Concern / Reason for Visit</label>
                <textarea
                  rows={2}
        ...
        <PatientTable
          ...
          title="OPD Registered Patients"
          subtitle="All patients queued or assisted today at the kiosk"
        />
      )}
